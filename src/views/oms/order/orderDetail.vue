  ...
  <div class="detail-container">
    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      >
        ...
        <el-table-column label="数量" width="120" align="center" prop="productQuantity" />
      ...
      >
        ...
        <el-table-column label="付款状态" width="120" align="center">
          <template slot-scope="scope">{{ scope.row.orderStatus | formatPayStatus }}</template>
        </el-table-column>
        <el-table-column label="发货状态" width="120" align="center">
          <template slot-scope="scope">{{ scope.row.orderStatus | formatDeliverStatus }}</template>
        </el-table-column>
