<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      />
      <el-input
        v-model="listQuery.recommendUserId"
        type="number"
        clearable
        class="filter-item"
        style="width: 200px;"
      ...
      <el-button
        v-permission="['GET /admin/buffetcouponorder/list']"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
        @click="handleFilter"
    ...
    >
      <el-table-column align="center" width="80" label="ID" prop="id"/>
...
<script>
import { listDelivery, detDelivery, statusDelivery } from '@/api/business'
