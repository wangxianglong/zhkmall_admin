  ...
  <div style="margin-top: 50px">
    ...
    >
      ...
      <el-form-item label="商品规格：">
        ...
        <el-table :data="value.skuStockList" style="width: 100%;margin-top: 20px" border>
          <el-table-column
      ...
      <el-form-item label="规格参数：">
        <el-tabs v-model="activeHtmlName" type="card">
          <el-tab-pane label="电脑端详情" name="pc">
            <tinymce :width="595" :height="300" v-model="value.detailHtml" />
          </el-tab-pane>
          <el-tab-pane label="移动端详情" name="mobile">
            <tinymce :width="595" :height="300" v-model="value.detailMobileHtml" />
          </el-tab-pane>
        </el-tabs>
      </el-form-item>
