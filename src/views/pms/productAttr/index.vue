<template>
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <el-button class="btn-add" size="mini" @click="addProductAttrCate()">添加</el-button>
    </el-card>
...
<script>
import { attrCategoryList, createProductAttrCate, deleteProductAttrCate, updateProductAttrCate } from '@/api/productAttrCate'
...
export default {
  ...
  methods: {
    getList() {
      ...
      attrCategoryList(this.listQuery).then(response => {
