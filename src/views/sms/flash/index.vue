<template>
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table v-loading="listLoading" ref="flashTable" :data="list" style="width: 100%;" border>
    ...
    <el-dialog :visible.sync="dialogVisible" title="添加活动" width="40%">
      <el-form ref="flashPromotionForm" :model="flashPromotion" label-width="150px" size="small">
